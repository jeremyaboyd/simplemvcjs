# Examples / SimpleBlog
This example shows you the most basic blog imaginable, the posts are in an array, but there is no reason you couldn't load them with Sequelize via `SimpleMVC.getSequelize()`.
### Getting it to work
